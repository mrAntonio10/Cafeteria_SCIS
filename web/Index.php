...
if (empty($fijo)) {
  ...
  echo "<img src=\"include/logo.png\" alt=\"login-icon\" style= \"height: 10rem\"; >";
  echo "</div>";
  ...
  echo "<input  class=\"form-control bg-light\" placeholder=\"User\"  name=\"USER\" required style=\"text-align:\" type=\"email\">"; 
  echo "</div>";
